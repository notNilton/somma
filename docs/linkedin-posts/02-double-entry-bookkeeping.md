...
Muitos apps de finanças se limitam a registrar um "log de gastos". No **Tallyoh**, optei por uma abordagem de **Partidas Dobradas (Double-Entry Bookkeeping)**. Parece complexo, mas é o segredo para nunca ter que perguntar "uai, para onde foi esse dinheiro?".
...
✅ **Previsibilidade:** No Tallyoh, cada "conta" (corrente, poupança, investimento, cofre) é tratada como uma entidade independente no banco, permitindo reconciliações bancárias robustas.
...
3. **Link:** No primeiro comentário, coloque o link para o README do projeto Tallyoh.
