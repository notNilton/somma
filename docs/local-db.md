...
Isso já bate com [apps/backend/.env.example](/var/home/notNilton/Workspace/nilbyte/tallyoh/apps/backend/.env.example).
...
O seed SQL usado hoje está em [database/seeds/initial_seed.sql](/var/home/notNilton/Workspace/nilbyte/tallyoh/database/seeds/initial_seed.sql).
